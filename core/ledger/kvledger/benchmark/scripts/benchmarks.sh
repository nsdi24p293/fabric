...
# 'BenchmarkInsertTxs' in package 'github.com/osdi23p228/fabric/core/ledger/kvledger/benchmark/experiments'
#
# runReadWriteTxs - This function sets the environment variables and runs the benchmark function
# 'BenchmarkReadWriteTxs' in package 'github.com/osdi23p228/fabric/core/ledger/kvledger/benchmark/experiments'
#
# For the details of test specific parameters, refer to the documentation in 'go' files for the tests
#######################################################################################################

PKG_NAME="github.com/osdi23p228/fabric/core/ledger/kvledger/benchmark/experiments"
