...
repository](https://github.com/osdi23p228/fabric/), whereas all international
...
folder](https://github.com/osdi23p228/fabric/tree/master/docs) in the
...
* US English
  [`CODEOWNERS`](https://github.com/osdi23p228/fabric/blob/master/CODEOWNERS)
...
- Instead you need to update the `_preamble.md` or `_postscript.md` files under
  `src/github.com/osdi23p228/fabric/docs/wrappers` for the command.
...
- Add a section for your CLI command in
  `src/github.com/osdi23p228/fabric/scripts/generateHelpDoc.sh`.
- Create two new files under `/src/github.com/osdi23p228/fabric/docs/wrappers`
