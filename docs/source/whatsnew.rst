...
* `Fabric v2.0.0 release notes <https://github.com/osdi23p228/fabric/releases/tag/v2.0.0>`_.
* `Fabric v2.0.1 release notes <https://github.com/osdi23p228/fabric/releases/tag/v2.0.1>`_.
* `Fabric v2.1.0 release notes <https://github.com/osdi23p228/fabric/releases/tag/v2.1.0>`_.
* `Fabric v2.1.1 release notes <https://github.com/osdi23p228/fabric/releases/tag/v2.1.1>`_.
* `Fabric v2.2.0 release notes <https://github.com/osdi23p228/fabric/releases/tag/v2.2.0>`_.
* `Fabric v2.2.1 release notes <https://github.com/osdi23p228/fabric/releases/tag/v2.2.1>`_.
* `Fabric v2.2.2 release notes <https://github.com/osdi23p228/fabric/releases/tag/v2.2.2>`_.
