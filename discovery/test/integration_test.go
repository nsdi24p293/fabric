...
import (
	...
	bccsp "github.com/osdi23p228/fabric/bccsp/utils"
	...
	lifecyclemocks "github.com/osdi23p228/fabric/core/cclifecycle/mocks"
	"github.com/osdi23p228/fabric/core/common/ccprovider"
	"github.com/osdi23p228/fabric/discovery"
	disc "github.com/osdi23p228/fabric/discovery/client"
	...
	"github.com/osdi23p228/fabric/discovery/support/mocks"
	"github.com/osdi23p228/fabric/gossip/api"
	gcommon "github.com/osdi23p228/fabric/gossip/common"
	gdisc "github.com/osdi23p228/fabric/gossip/discovery"
...
func buildBinaries() error {
	...
	idemixgen, err = gexec.Build("github.com/osdi23p228/fabric/cmd/idemixgen")
	if err != nil {
		return errors.WithStack(err)
	}
	return nil
