...
func (c *Components) ConfigTxGen() string {
	return c.Build("github.com/osdi23p228/fabric/cmd/configtxgen")
}

func (c *Components) Cryptogen() string {
	return c.Build("github.com/osdi23p228/fabric/cmd/cryptogen")
}

func (c *Components) Discover() string {
	return c.Build("github.com/osdi23p228/fabric/cmd/discover")
}

func (c *Components) Idemixgen() string {
	return c.Build("github.com/osdi23p228/fabric/cmd/idemixgen")
}

func (c *Components) Orderer() string {
	return c.Build("github.com/osdi23p228/fabric/cmd/orderer")
}

func (c *Components) Peer() string {
	return c.Build("github.com/osdi23p228/fabric/cmd/peer")
}
